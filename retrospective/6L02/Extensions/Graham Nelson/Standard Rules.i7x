...
Document C16ActionNotSpecific C16ActionTooSpecific C16UnknownTryAction1 C16UnknownTryAction2 ph_try ph_trysilently at doc102 "7.4" "7.4. Try and try silently".
Document rules_after at doc103 "7.5" "7.5. After rules".
Document C22APWithDisjunction C22APWithImmiscible at doc106 "7.8" "7.8. Rules applying to more than one action".
Document var_noun at doc108 "7.10" "7.10. The noun and the second noun".
Document C14CantAssertAdjective C14CantAssertNegatedEverywhere C14CantAssertNegatedRelations C14CantAssertNonKind C14CantAssertQuantifier C6NegatedVerb1 C6TwoLikelihoods C8NoSuchVerb C8NoSuchVerbComma at doc11 "2.1" "2.1. Creating the world".
Document C22APWithBadWhen C22NonActionInPresenceOf at doc110 "7.12" "7.12. In the presence of, and when".
Document C24GoingWithoutObject C24GoingWrongKind at doc112 "7.14" "7.14. Going by, going through, going with".
Document C24NamedAPWithActor KACTIONS at doc113 "7.15" "7.15. Kinds of action".
...
Document C14CantChangeKind C14CantForceCalling C14CantForceExistence C14CantForceGeneralised C14CantForceRelation C16BadNow1 C16BadNow2 C16BadNow3 C22RedefinedNow ph_now at doc127 "8.11" "8.11. Now...".
Document ph_decrease ph_decrement ph_increase ph_increment at doc128 "8.12" "8.12. Increasing and decreasing".
Document C5TooMuchQuotedText C5UnendingComment C5UnendingQuote C5WordTooLong C8EnigmaticPronoun C8EnigmaticThey at doc13 "2.3" "2.3. Punctuation".
Document C22CalledThe C22CalledWithDash at doc131 "8.15" "8.15. Calling names".
...
Document C14RandomImpossible ph_randomdesc at doc135 "8.19" "8.19. Random choices of things".
...
Document C16NumberOfTurns rules_et at doc140 "9.5" "9.5. Every turn".
...
Document C10AtWithoutTime C22UnusedTimedEvent TIMEDEVENTS ph_attime ph_timefromnow ph_turnsfromnow at doc146 "9.11" "9.11. Future events".
Document C24PTAPTooComplex at doc147 "9.12" "9.12. Actions as conditions".
Document C12DescSubordinatePast C12PastActionCalled C13PastSubordinate C24PTAPMakesCallings C24PastCallings C24PastTableEntries C24PastTableLookup C6NonPresentTense at doc148 "9.13" "9.13. The past and perfect tenses".
Document C20BadTitleSentence C6HeadingOverLine C6HeadingStopsBeforeEndOfLine HEADINGS at doc15 "2.5" "2.5. Headings".
Document SCENESINTRO kind_scene at doc151 "10.1" "10.1. Introduction to scenes".
Document C19ScenesBadCondition C19ScenesDisallowCalled C19ScenesNotPlay C19ScenesOnly C19ScenesOversetEnd C19ScenesUnknownEnd at doc152 "10.2" "10.2. Creating a scene".
...
Document C22BareTo at doc161 "11.2" "11.2. The phrasebook".
Document C22AdjacentTokens C22BadTypeIndication C22PhraseTooLong C22SaySlashed C22TokenMisunderstood C22TokenWithEmptyBrackets C22TokenWithNestedBrackets C22TokenWithStipulations C22TokenWithoutCloseBracket C22TokenWithoutOpenBracket at doc162 "11.3" "11.3. Pattern matching".
Document ph_showme at doc163 "11.4" "11.4. The showme phrase".
Document C22TruthStateToDecide kind_truthstate ph_consents ph_indarkness ph_whether at doc164 "11.5" "11.5. Conditions and questions".
Document C16WrongThen C8IfOutsidePhrase ph_if ph_unless at doc165 "11.6" "11.6. If".
Document C16CantUseOutsideStructure C16EndWithoutBegin C16PossibleUnterminatedIf C16PossibleUnterminatedUnless C16WrongEnd C22BeginWithoutEnd C22BlockNestingTooDeep C6BothBlockSyntaxes C6EmptyIndentedBlock C6MisalignedIndentation C6NotInOldSyntax C6RunOnsInTabbedRoutine at doc166 "11.7" "11.7. Begin and end".
Document C16BlockWithinNonblock C16CaseValueMismatch C16CaseValueNonConstant C16DoubleOtherwise C16OtherwiseIfAfterOtherwise C16OtherwiseInNonIf C16OtherwiseWithoutIf C16WrongOtherwise C16WrongOtherwise2 C16WrongOtherwise3 C6MisalignedCase C6MisalignedOtherwise C6MisarrangedOtherwise C6NonCaseInIf ph_otherwise ph_switch at doc167 "11.8" "11.8. Otherwise".
Document ph_while at doc168 "11.9" "11.9. While".
Document C14CalledInRepeat ph_repeat at doc169 "11.10" "11.10. Repeat".
Document C14BadRepeatDomain ph_runthrough at doc170 "11.11" "11.11. Repeat running through".
Document C16CantUseOutsideLoop ph_break ph_next at doc171 "11.12" "11.12. Next and break".
Document ph_stop at doc172 "11.13" "11.13. Stop".
Document C22NotAPhraseOption C22NotTheOnlyPhraseOption C22PhraseOptionsExclusive C22SayWithPhraseOptions C22TooManyPhraseOptions ph_listcontents at doc173 "11.14" "11.14. Phrase options".
Document C22TooManyLocals ph_let ph_letdefault at doc174 "11.15" "11.15. Let and temporary variables".
Document ph_no ph_yes at doc175 "11.16" "11.16. New conditions, new adjectives".
Document C22RedundantReturnKOV C22ReturnWrongKind C22UnknownValueToDecide ph_decideon at doc176 "11.17" "11.17. Phrases to decide other things".
...
Document C25TestBadRequirements C25TestCommandTooLong C25TestContainsUndo C25TestDoubleWith C25TestDuplicate C25TestMultiWord C25UnknownInternalTest at doc18 "2.8" "2.8. The TEST command".
...
Document C24ActionAlreadyExists C24ActionBothValues C24ActionClauseUnknown C24ActionMisapplied C24GrammarMismatchesAction C24MatchedAsTooLong C24MultiwordPastParticiple NEWACTIONS ph_requirescarried ph_requirescarried2 ph_requireslight ph_requirestouch ph_requirestouch2 at doc184 "12.7" "12.7. New actions".
Document C14ActionVarsPastTense C24ActionVarAnd C24ActionVarOverspecific C24ActionVarUnknownKOV C24ActionVarValue C24BadMatchingSyntax C24BadOptionalAPClause at doc187 "12.10" "12.10. Action variables".
Document C22DuplicateRuleName C23RuleWithComma at doc189 "12.12" "12.12. Check rules for actions by other people".
...
Document C24SetStoredAction kind_storedaction ph_actionof ph_actionpart ph_actorpart ph_currentaction ph_involves ph_nounpart ph_secondpart ph_trystored ph_trystoredsilently at doc197 "12.20" "12.20. Stored actions".
Document C17RelationWithBadProperty C17RelationWithEitherOrProperty C8BadRelation C8EveryWrongSide C8KindRelatedToValue C8PropForBadKOV VERBS at doc199 "13.1" "13.1. Sentence verbs".
Document C5BogusExtension at doc20 "2.10" "2.10. Installing extensions".
Document RELATIONS at doc201 "13.3" "13.3. What are relations?".
Document C17BadKOVForRelationProperty C9BothOneAndMany C9CantCallBoth C9CantCallLeft C9CantCallRight C9FRFUnavailable C9OneOrVariousWithWhen C9OneToOneMiscalled C9RelatedKindsUnknown C9RelationExists at doc203 "13.5" "13.5. Making new relations".
Document ph_showrelation at doc205 "13.7" "13.7. Relations in groups".
Document C9DuplicateVerbs1 C9DuplicateVerbs2 C9DuplicateVerbs3 C9PrepositionConjugated C9PrepositionLong C9PresentPluralTwice C9VerbMalformed C9VerbRelationUnknown C9VerbRelationVague C9VerbUnknownMeaning at doc207 "13.9" "13.9. Defining new assertion verbs".
Document C6CanHave at doc208 "13.10" "13.10. Defining new prepositions".
Document ph_nextstep ph_numbersteps at doc209 "13.11" "13.11. Indirect relations".
Document C7ExtInadequateVM C7ExtMalformedVM C7ExtMisidentified C7ExtMisidentifiedEnds C7ExtMiswordedBeginsHere C7ExtVersionMalformed C7IncludeExtQuoted at doc21 "2.11" "2.11. Including extensions".
Document C9BadRelationCondition C9Unassertable2 at doc210 "13.12" "13.12. Relations which express conditions".
...
Document C21UONotNumerical C21UnknownUseOption OPTIONS at doc22 "2.12" "2.12. Use options".
...
Document C10ElementOverflow C10EvenOverflow-G C10ZMachineOverflow C12LiteralOverflow C14CantEquateValues C14InequalityFailed kind_number kind_real_number at doc228 "15.2" "15.2. Numbers and real numbers".
...
Document C10LPBuiltInKOV C10LPEnumeration C10LPNotKOV C10NegationForbidden C10NegationInternal at doc234 "15.8" "15.8. Units".
Document C10DuplicateUnitSpec at doc235 "15.9" "15.9. Multiple notations".
Document C10LPTooLittleAccuracy C15LPCantScaleTwice C15LPCantScaleYet at doc236 "15.10" "15.10. Scaling and equivalents".
Document C21BadICLIdentifier STORYFILES at doc24 "2.14" "2.14. Limits and the Settings panel".
Document C10LPElementTooLarge C10LPNotAllNamed C10LPTooComplicated C10LPTooManyElements C10LPWithoutElement at doc240 "15.14" "15.14. Notations including more than one number".
Document C10BadLPNameOption C10BadLPPartOption C10LPFirstOptional C10LPMultipleOptional at doc241 "15.15" "15.15. The parts of a number specification".
Document C16TotalEitherOr C16TotalTableColumn ph_total at doc243 "15.17" "15.17. Totals".
Document C21EquationBadArithmetic C21EquationBadTarget C21EquationDimensionPower C21EquationDoesntEquate C21EquationEquatesBadly C21EquationEquatesMultiply C21EquationIncomparable C21EquationInsoluble C21EquationLeadingZero C21EquationMisnamed C21EquationMisnumbered C21EquationMispunctuated C21EquationOperatorUnrecognised C21EquationSymbolBadSub C21EquationSymbolEqualsKOV C21EquationSymbolMalformed C21EquationSymbolMisdeclared C21EquationSymbolMissing C21EquationSymbolNonNumeric C21EquationSymbolNonValue C21EquationSymbolSpurious C21EquationSymbolVague C21EquationSymbolWrongKOV C21EquationTokenUnrecognised C21EquationTooComplex EQUATIONS ph_letequation at doc244 "15.18" "15.18. Equations".
Document ARITHMETIC C10BadLPEquivalent C10BadLPOffset C10MultiplyingNonKOVs C15DimensionNotBaseKOV C15DimensionRedundant C15DimensionsInconsistent C15NonDimensional C15UnitSequenceOverflow C16BadArithmetic at doc246 "15.20" "15.20. Multiplication of units".
Document C20TableCoincidesWithKind C20TableColumnAlready C20TableColumnArticle C20TableColumnBrackets C20TableColumnEmptyLists C20TableDefiningObject C20TableDescriptionEntry C20TableEntryGeneric C20TableIncompatibleEntry C20TableKindlessColumn C20TableMisnamed C20TableNameAmbiguous C20TableNameDuplicate C20TableOfBuiltInKind C20TableOfExistingKind C20TableOfQuantifiedKind C20TablePlayerEntry C20TableRowFull C20TableTooManyColumns C20TableUndefined C20TableUnknownEntry C20TableVariableEntry C20TableWithBlankNames C20TableWithoutRows TABLES at doc247 "16.1" "16.1. Laying out tables".
...
Document C12NoRowSelected ph_chooserandomrow ph_chooserow ph_chooserowwith at doc251 "16.5" "16.5. Choosing rows".
...
Document C20TableDefiningNothing C20TableDefiningTheImpossible at doc262 "16.16" "16.16. Defining things with tables".
Document C20TableNotContinuation at doc264 "16.18" "16.18. Table continuations".
Document C20TableAmendmentMisfit C20TableAmendmentMismatch at doc265 "16.19" "16.19. Table amendments".
Document C25BizarreToken C25ComplexUnderstand C25LiteralPunctuation C25NontextualUnderstand C25NotNewCommand C25NotOldCommand C25ObsoleteHeldTokens C25OldVerbUsage C25OverComplexToken C25TextTokenRestricted C25TextlessMistake C25UnderstandAsActivity C25UnderstandAsBadValue C25UnderstandAsCompoundText C25UnderstandCommaCommand C25UnderstandCommandWhen C25UnderstandEmptyText C25UnderstandMismatch C25UnderstandVague C25UnknownToken C25UnparsableKind C25UseTextNotTopic C25UseThingNotObject UNDERSTANDING someone_token at doc266 "17.1" "17.1. Understand".
Document C25GrammarIllFounded C25ThreeValuedLine C25TooManyAliases C25TooManyGrammarLines at doc267 "17.2" "17.2. New commands for old grammar".
...
Document C25UnderstandAsQualified C25UnderstandPluralValue at doc276 "17.11" "17.11. Understanding values".
Document C25OverAmbitiousSlash C25SlashedCommand at doc277 "17.12" "17.12. This/that".
Document C25MixedOutcome C25TwoValuedToken NEWTOKENS at doc278 "17.13" "17.13. New tokens".
Document C8DescriptionsEquated C8SameKindEquated MAP kind_room at doc28 "3.2" "3.2. Rooms and the map".
Document C25BadReferringProperty C25BadUnderstandProperty C25BadUnderstandPropertyAs C25UnknownUnderstandProperty C25UnknownUnpermittedProperty at doc280 "17.15" "17.15. Understanding things by their properties".
Document C25GrammarBadRelation C25GrammarObjectlessRelation C25GrammarValueRelation at doc281 "17.16" "17.16. Understanding things by their relations".
Document C25BadWhen at doc282 "17.17" "17.17. Context: understanding when".
...
Document ACTIVITIES C24BadActivityName kind_activity at doc287 "18.1" "18.1. What are activities?".
Document C22BadWhenWhile at doc290 "18.4" "18.4. While clauses".
Document EXTACTIVITIES ph_carryout ph_carryoutwith ph_continueactivity at doc291 "18.5" "18.5. New activities".
Document C24ActivityVarAnd C24ActivityVarOverspecific C24ActivityVarUnknownKOV C24ActivityVarValue C24ActivityVariableNameless at doc292 "18.6" "18.6. Activity variables".
...
Document C19ExistingRegion C19RegionInTwoRegions C19RegionRelation REGIONS kind_region at doc30 "3.4" "3.4. Regions and the index map".
...
Document C11KindsIncompatible C19BothRoomAndSupporter C19CantContainAndSupport C19MiseEnAbyme KINDS at doc31 "3.5" "3.5. Kinds".
...
Document C23RulebookWithAt C23RulebookWithDefinition C23RulebookWithTo RULEBOOKS kind_rule kind_rulebook at doc327 "19.1" "19.1. On rules".
Document C22BadRulePreamble C22BadRulePreambleWhen C22RuleWithDefiniteArticle C8RuleWithoutColon at doc329 "19.3" "19.3. New rules".
Document C18PropertyNotPermitted at doc33 "3.7" "3.7. Properties depend on kind".
Document C23BadRulePlacementNegation C23ImproperRulePlacement C23NoSuchRuleExists C23PlaceWithMissingRule C23UnspecifiedRulebookPlacement RLISTING at doc330 "19.4" "19.4. Listing rules explicitly".
...
Document C23RulebookVariableAnd C23RulebookVariableBadKind C23RulebookVariableTooSpecific C23RulebookVariableVague at doc336 "19.10" "19.10. Rulebook variables".
Document C23BadDefaultOutcome C23DefaultOutcomeTwice ph_failed ph_fails ph_nodecision ph_succeeded ph_succeeds at doc337 "19.11" "19.11. Success and failure".
Document C16MisplacedRulebookOutcome C22WrongEndToPhrase C23BadOutcomeClarification C23DefaultNamedOutcomeTwice C23DefaultOutcomeAlready C23DuplicateOutcome C23NonOutcomeProperty ph_rulebookoutcome at doc338 "19.12" "19.12. Named outcomes".
...
Document C13EverywhereMisapplied C14CantChangeEverywhere C19EverywhereNonBackdrop kind_backdrop at doc35 "3.9" "3.9. Backdrops".
...
Document C16CantLetEmptyList C20BadConstantListEntry C20IncompatibleConstantListEntry C20NonconstantConstantListEntry at doc353 "21.2" "21.2. Constant lists".
...
Document C17TwoAppearances C8TextWithoutSubject at doc37 "3.11" "3.11. Two descriptions of things".
Document C6UnknownVirtualMachine at doc375 "23.3" "23.3. Virtual machines and story file formats".
Document FIGURES kind_figurename at doc376 "23.4" "23.4. Gathering the figures".
Document C26PictureDuplicate C26PictureNotTextual at doc377 "23.5" "23.5. Declaring and previewing the figures".
...
Document C19BadMapCell C19BothWaysDoor C19DoorInThirdRoom C19DoorOverconnected C19DoorToNonRoom C19DoorUnconnected C19RoomMissingDoor kind_door ph_backside ph_directionofdoor ph_frontside ph_othersideof at doc38 "3.12" "3.12. Doors".
Document C26SoundDuplicate C26SoundNotTextual ph_playsf at doc380 "23.8" "23.8. Declaring and playing back sounds".
...
Document C26BadFileIFID C26BadFileOwner C26FilenameDuplicate C26FilenameNotTextual C26FilenameUnsafe kind_externalfile at doc384 "23.12" "23.12. Declaring files".
...
Document C20BadEpisode at doc397 "25.2" "25.2. Bibliographic data".
Document LCARDS at doc399 "25.4" "25.4. The Library Card".
Document C19NoStartRoom C19StartsOutsideRooms at doc4 "1.4" "1.4. The Go! button".
...
Document C20NoSuchPublicRelease release_files at doc401 "25.6" "25.6. The Release button and the Materials folder".
Document C20ReleaseAlong at doc402 "25.7" "25.7. The Joy of Feelies".
...
Document C19RoomInIgnoredSource at doc410 "25.15" "25.15. Republishing existing works of IF".
...
Document C6ExtBeginsAfterEndsHere C6ExtEndsWithoutBegins C6ExtMultipleBeginsHere C6ExtMultipleEndsHere C6ExtNoBeginsHere C6ExtNoEndsHere at doc434 "27.5" "27.5. A simple example extension".
Document C7ExtNoVersion C7ExtVersionTooLow phs_compextcredits phs_extcredits at doc435 "27.6" "27.6. Version numbering".
Document C6HeadingInPlaceOfUnincluded C6HeadingInPlaceOfUnknown C6UnequalHeadingInPlaceOf at doc438 "27.9" "27.9. Extensions can interact with other extensions".
Document C8ImplicationCertain C8ImplicationValueProperty at doc442 "27.13" "27.13. Implications".
Document C22BadInlineExpansion C22BadInlineTag C22InlineRule C22InlineTooLong C22NonInlineBeginEnd C5UnendingI6 at doc444 "27.15" "27.15. Defining phrases in Inform 6".
Document C11BadObjectTranslation at doc450 "27.21" "27.21. Inform 6 objects and classes".
Document C17NonPropertyTranslated C17TranslatedTwice C20NonQuantityTranslated C20QuantityTranslatedAlready C24TranslatesActionAlready C24TranslatesNonAction C2TranslatedToNonIdentifier C2TranslatedUnknownCategory at doc451 "27.22" "27.22. Inform 6 variables, properties, actions, and attributes".
Document C25GrammarTranslatedAlready at doc452 "27.23" "27.23. Inform 6 Understand tokens".
Document C10UnicodeAlready C10UnicodeNonLiteral C10UnicodeOutOfRange at doc454 "27.25" "27.25. Naming Unicode characters".
Document C21BadI6Inclusion C21BeforeTheLibrary C21WhenDefiningUnknown C27NoSuchPart C27NoSuchTemplate at doc455 "27.26" "27.26. The template layer".
Document C2LabelNamespaceTooLong at doc458 "27.29" "27.29. Invocation labels, counters and storage".
Document kind_player's at doc47 "3.21" "3.21. The player's holdall".
Document C19PartOfRoom C19RoomOrDoorAsPart at doc49 "3.23" "3.23. Parts of things".
Document ph_locationof at doc51 "3.25" "3.25. The location of something".
Document C19DirectionTooLong C19ImproperlyMadeDirection C19NamelessDirection C6TooManyDirections kind_direction at doc52 "3.26" "3.26. Directions".
Document NEWKINDS at doc53 "4.1" "4.1. New kinds".
Document C5PluralIsQuoted C5PluralOfQuoted at doc56 "4.4" "4.4. Plural assertions".
Document KINDSVALUE at doc57 "4.5" "4.5. Kinds of value".
Document C8ValueCantHaveProperties C8ValueCantHaveVProperties at doc58 "4.6" "4.6. Properties again".
Document C16EitherOrAsValue C8MiscellaneousEOProblem C8NonObjectCanBe C8QualifiedCanBe C8ThisIsEitherOr at doc59 "4.7" "4.7. New either/or properties".
Document C16PropertyOfKind C17BadProvides C17PropertyUninitialisable C25BadVisibilityWhen C6PropertyCalledArticle C6PropertyCalledPresence C6PropertyNameForbidden C8PropertyKindClashes C8PropertyKindUnknown C8PropertyKindVague C8PropertyTooSpecific C8RedundantThatVaries at doc60 "4.8" "4.8. New value properties".
Document C8EitherOnThree at doc62 "4.10" "4.10. Conditions of things".
Document ph_defaultvalue at doc63 "4.11" "4.11. Default values of kinds".
Document C15EmptyKind VARIABLES var_location at doc64 "4.12" "4.12. Values that vary".
Document C8TooManyDuplicates at doc66 "4.14" "4.14. Duplicates".
Document C8AssemblyLoop C8AssemblyRegress C8ComplexEvery at doc67 "4.15" "4.15. Assemblies and body parts".
Document C12TSWithComma C12TSWithPunctuation at doc70 "5.1" "5.1. Text with substitutions".
...
Document C22SayEndIfWithoutSayIf C22SayIfNested C22SayOtherwiseWithoutIf phs_elseif phs_elseunless phs_endif phs_endunless phs_if phs_otherwise phs_unless at doc75 "5.6" "5.6. Text with variations".
...
Document C16MidTextUnicode C16SayUnicode phs_unicode at doc80 "5.11" "5.11. Unicode characters".
...
Document C22DefinitionBadCondition C22DefinitionWithoutCondition C9AdjDomainSlippery C9AdjDomainSurreal C9AdjDomainUnknown C9ArticleAsAdjective at doc86 "6.4" "6.4. Defining new adjectives".
Document C17ComparativeMisapplied C17GradingCalled C17GradingMisphrased C17GradingNonLiteral C17GradingUnknownProperty C17GradingUnless C17GradingWrongKOV C17MultiwordGrading at doc89 "6.7" "6.7. Comparatives".
Document C16OutOfPlay at doc92 "6.10" "6.10. Existence and there".
...
Document C8ComplexDeterminer at doc97 "6.15" "6.15. All, each and every".
Document ACTIONS C22APUnknown C22APWithNoParticiple C22NonActionIn kind_actionname at doc99 "7.1" "7.1. Actions".
[...and so on...]
...
Definition: a text is substituted rather than unsubstituted if I6 routine
	"TEXT_TY_IsSubstituted" says so (it contains no characters).
...
To say first time -- beginning say_first_time (documented at phs_firsttime):
	...
	if ((I7_ST_say_first_time-->{-counter:say_first_time}{-counter-up:say_first_time})++ == 0) {-open-brace}
		-).
...
To silently try (doing something - action)
	...
	(- @push keep_silent; keep_silent=1; @push say__p; @push say__pc;
		ClearParagraphing(); {doing something}; DivideParagraphPoint();
