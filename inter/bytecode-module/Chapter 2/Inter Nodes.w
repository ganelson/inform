...
=
inter_t Inode::get_metadata(inter_tree_node *F, int at) {
	if (F == NULL) return 0;
	return F->W.repo_segment->bytecode[F->W.index + at];
}

void Inode::set_metadata(inter_tree_node *F, int at, inter_t V) {
...
inter_symbols_table *Inode::ID_to_symbols_table(inter_tree_node *F, inter_t ID) {
	return Inter::Warehouse::get_symbols_table(Inode::warehouse(F), ID);
}

text_stream *Inode::ID_to_text(inter_tree_node *F, inter_t ID) {
	return Inter::Warehouse::get_text(Inode::warehouse(F), ID);
}

inter_package *Inode::ID_to_package(inter_tree_node *F, inter_t ID) {
	if (ID == 0) return NULL; // yes?
	return Inter::Warehouse::get_package(Inode::warehouse(F), ID);
}

inter_node_list *Inode::ID_to_frame_list(inter_tree_node *F, inter_t N) {
	return Inter::Warehouse::get_frame_list(Inode::warehouse(F), N);
}

void *Inode::ID_to_ref(inter_tree_node *F, inter_t N) {
...
inter_tree_node *Inode::fill_0(inter_bookmark *IBM, int S, inter_error_location *eloc, inter_t level) {
...
inter_tree_node *Inode::fill_1(inter_bookmark *IBM, int S, inter_t V, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_2(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_3(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_t V3, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_4(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_t V3, inter_t V4, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_5(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_t V3, inter_t V4, inter_t V5, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_6(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_t V3, inter_t V4, inter_t V5, inter_t V6, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_7(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_t V3, inter_t V4, inter_t V5, inter_t V6, inter_t V7, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
inter_tree_node *Inode::fill_8(inter_bookmark *IBM, int S, inter_t V1, inter_t V2, inter_t V3, inter_t V4, inter_t V5, inter_t V6, inter_t V7, inter_t V8, inter_error_location *eloc, inter_t level) {
	inter_tree *I = Inter::Bookmarks::tree(IBM);
...
@ =
int Inode::extend(inter_tree_node *F, inter_t by) {
	if (by == 0) return TRUE;
	...
	inter_t a = Inode::get_metadata(F, PREFRAME_VERIFICATION_COUNT);
	inter_t b = Inode::get_metadata(F, PREFRAME_ORIGIN);
	inter_t c = Inode::get_metadata(F, PREFRAME_COMMENT);
...
inter_t Inode::vcount(inter_tree_node *F) {
	inter_t v = Inode::get_metadata(F, PREFRAME_VERIFICATION_COUNT);
	Inode::set_metadata(F, PREFRAME_VERIFICATION_COUNT, v + 1);
	return v;
}

inter_t Inode::to_index(inter_tree_node *F) {
...
inter_t Inode::get_comment(inter_tree_node *F) {
	if (F) return Inode::get_metadata(F, PREFRAME_COMMENT);
	return 0;
}

void Inode::attach_comment(inter_tree_node *F, inter_t ID) {
...
inter_t Inode::get_package_alt(inter_tree_node *X) {
	inter_tree_node *F = X;
	while (TRUE) {
