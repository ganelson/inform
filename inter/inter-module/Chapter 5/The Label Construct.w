...
void Inter::Label::verify(inter_construct *IC, inter_frame *P, inter_package *owner, inter_error_message **E) {
	if (P->node->W.extent != EXTENT_LABEL_IFR) { *E = Inter::Frame::error(P, I"extent wrong", NULL); return; }
	...
	if (P->node->W.data[LEVEL_IFLD] < 1) { *E = Inter::Frame::error(P, I"label with bad level", NULL); return; }
