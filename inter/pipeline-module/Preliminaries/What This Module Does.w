...
@h Pipelines.
This module provides a mechanism for working on trees of Inter code, by applying
sequences of "stages" identified by name; and it then defines a number of stages.
