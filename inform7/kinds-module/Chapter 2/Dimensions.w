...
void Kinds::Dimensions::kind_rescale_multiplication_emit_op(kind *kindx, kind *kindy) {
	...
	int k_Y = Kinds::Behaviour::scale_factor(kindy);
	int k_O = Kinds::Behaviour::scale_factor(kindo);
	if (k_X*k_Y > k_O) { Emit::inv_primitive(Produce::opcode(DIVIDE_BIP)); Emit::down(); }
	if (k_X*k_Y < k_O) { Emit::inv_primitive(Produce::opcode(TIMES_BIP)); Emit::down(); }
}
...
void Kinds::Dimensions::kind_rescale_multiplication_emit_factor(kind *kindx, kind *kindy) {
	...
	int k_Y = Kinds::Behaviour::scale_factor(kindy);
	int k_O = Kinds::Behaviour::scale_factor(kindo);
	if (k_X*k_Y > k_O) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_X*k_Y/k_O)); Emit::up(); }
	if (k_X*k_Y < k_O) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_O/k_X/k_Y)); Emit::up(); }
}
#endif
...
void Kinds::Dimensions::kind_rescale_division_emit_op(kind *kindx, kind *kindy) {
	...
	int k_Y = Kinds::Behaviour::scale_factor(kindy);
	int k_O = Kinds::Behaviour::scale_factor(kindo);
	if (k_O*k_Y > k_X) { Emit::inv_primitive(Produce::opcode(TIMES_BIP)); Emit::down(); }
	if (k_O*k_Y < k_X) { Emit::inv_primitive(Produce::opcode(DIVIDE_BIP)); Emit::down(); }
}
...
void Kinds::Dimensions::kind_rescale_division_emit_factor(kind *kindx, kind *kindy) {
	...
	int k_Y = Kinds::Behaviour::scale_factor(kindy);
	int k_O = Kinds::Behaviour::scale_factor(kindo);
	if (k_O*k_Y > k_X) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_O*k_Y/k_X)); Emit::up(); }
	if (k_O*k_Y < k_X) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_X/k_O/k_Y)); Emit::up(); }
}
#endif
...
@<Emit a scaling correction for square roots@> =
	if (k_O*k_O > k_X) { Emit::inv_primitive(Produce::opcode(TIMES_BIP)); Emit::down(); }
	if (k_O*k_O < k_X) { Emit::inv_primitive(Produce::opcode(DIVIDE_BIP)); Emit::down(); }
...
@<Emit a scaling correction for cube roots@> =
	if (k_O*k_O*k_O > k_X) { Emit::inv_primitive(Produce::opcode(TIMES_BIP)); Emit::down(); }
	if (k_O*k_O*k_O < k_X) { Emit::inv_primitive(Produce::opcode(DIVIDE_BIP)); Emit::down(); }
...
@<Emit factor for a scaling correction for square roots@> =
	if (k_O*k_O > k_X) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_O*k_O/k_X)); Emit::up(); }
	if (k_O*k_O < k_X) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_X/k_O/k_O)); Emit::up(); }
...
@<Emit factor for a scaling correction for cube roots@> =
	if (k_O*k_O*k_O > k_X) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_O*k_O*k_O/k_X)); Emit::up(); }
	if (k_O*k_O*k_O < k_X) { Emit::val(K_number, LITERAL_IVAL, (inter_t) (k_X/k_O/k_O/k_O)); Emit::up(); }
