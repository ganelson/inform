...
void PL::Actions::start(void) {
	...
	PluginManager::plug(PRODUCTION_LINE_PLUG, PL::Actions::compile_runtime);
...
int PL::Actions::compile_runtime(int stage, int debugging, stopwatch_timer *sequence_timer) {
