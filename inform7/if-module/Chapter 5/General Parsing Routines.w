...
void PL::Parsing::Tokens::General::top_of_head(gpr_kit *gprk, inter_name *gv_iname, inference_subject *subj,
		...
		Produce::down();
			...
			Produce::down();
				...
				Produce::down();
					...
					Produce::down();
						Produce::val_text(I"Parse_name called\n");
					Produce::up();
				Produce::up();
			Produce::up();
		Produce::up();
	...
	if ((gv_iname) && (sometimes_has_visible_properties == FALSE)) {
		...
		Produce::down();
			...
			Produce::down();
				Produce::val_iname(K_value, Hierarchy::find(PARSER_ACTION_HL));
				Produce::val_iname(K_value, Hierarchy::find(THESAME_HL));
			Produce::up();
			Produce::code();
			Produce::down();
	...
	Produce::down();
		Produce::ref_symbol(K_value, gprk->pass_s);
	...
	Produce::down();
		...
		Produce::down();
			Produce::val_symbol(K_value, gprk->pass_s);
			Produce::val(K_number, LITERAL_IVAL, 3);
		Produce::up();
		Produce::code();
		Produce::down();
			...
			Produce::inv_primitive(Produce::opcode(STORE_BIP));
			Produce::down();
				Produce::ref_symbol(K_value, gprk->try_from_wn_s);
			...
			Produce::inv_primitive(Produce::opcode(STORE_BIP));
			Produce::down();
				Produce::ref_symbol(K_value, gprk->n_s);
				Produce::val(K_number, LITERAL_IVAL, 0);
			Produce::up();
			Produce::inv_primitive(Produce::opcode(WHILE_BIP));
			Produce::down();
				...
				Produce::down();
					...
					Produce::down();
						...
						Produce::down();
							Produce::inv_primitive(Produce::opcode(WHILE_BIP));
							Produce::down();
								Produce::inv_call_iname(Hierarchy::find(WORDINPROPERTY_HL));
								Produce::down();
									Produce::inv_call_iname(Hierarchy::find(NEXTWORDSTOPPED_HL));
									Produce::val_iname(K_value, Hierarchy::find(SELF_HL));
									Produce::val_iname(K_value, PL::Parsing::Visibility::name_name());
								Produce::up();
								Produce::code();
								Produce::down();
									Produce::inv_primitive(Produce::opcode(STORE_BIP));
...
void PL::Parsing::Tokens::General::after_gl_failed(gpr_kit *gprk, inter_symbol *label, int pluralised) {
	if (pluralised) {
		Produce::inv_primitive(Produce::opcode(STORE_BIP));
		Produce::down();
			Produce::ref_iname(K_value, Hierarchy::find(PARSER_ACTION_HL));
			Produce::val_iname(K_value, Hierarchy::find(PLURALFOUND_HL));
		Produce::up();
	}
	Produce::inv_primitive(Produce::opcode(STORE_BIP));
	Produce::down();
	...
	Produce::place_label(label);
	Produce::inv_primitive(Produce::opcode(STORE_BIP));
	Produce::down();
		Produce::ref_iname(K_value, Hierarchy::find(WN_HL));
		Produce::val_symbol(K_value, gprk->try_from_wn_s);
	Produce::up();
}
...
void PL::Parsing::Tokens::General::compile_parse_name_tail(gpr_kit *gprk) {
					Produce::inv_primitive(Produce::opcode(BREAK_BIP));
				Produce::up();
			Produce::up();
			...
			Produce::down();
				...
				Produce::down();
					...
					Produce::down();
						Produce::val_symbol(K_value, gprk->n_s);
						Produce::val(K_number, LITERAL_IVAL, 0);
					Produce::up();
				Produce::up();
				Produce::code();
			...
			Produce::down();
				...
				Produce::down();
					Produce::inv_primitive(Produce::opcode(STORE_BIP));
					Produce::down();
						Produce::ref_symbol(K_value, gprk->pass1_n_s);
						Produce::val_symbol(K_value, gprk->n_s);
					Produce::up();
				Produce::up();
			Produce::up();
			...
			Produce::down();
				...
				Produce::down();
					Produce::inv_primitive(Produce::opcode(STORE_BIP));
					Produce::down();
						Produce::ref_symbol(K_value, gprk->pass2_n_s);
						Produce::val_symbol(K_value, gprk->n_s);
					Produce::up();
				Produce::up();
			Produce::up();
		...
		Produce::down();
			...
			Produce::down();
				...
				Produce::down();
					Produce::inv_primitive(Produce::opcode(PRINT_BIP));
					Produce::down();
						Produce::val_text(I"Pass 1: ");
					Produce::up();
					Produce::inv_primitive(Produce::opcode(PRINTNUMBER_BIP));
					Produce::down();
						Produce::val_symbol(K_value, gprk->pass1_n_s);
					Produce::up();
					Produce::inv_primitive(Produce::opcode(PRINT_BIP));
					Produce::down();
						Produce::val_text(I" Pass 2: ");
					Produce::up();
					Produce::inv_primitive(Produce::opcode(PRINTNUMBER_BIP));
					Produce::down();
						Produce::val_symbol(K_value, gprk->pass2_n_s);
					Produce::up();
					Produce::inv_primitive(Produce::opcode(PRINT_BIP));
					Produce::down();
						Produce::val_text(I" Pass 3: ");
					Produce::up();
					Produce::inv_primitive(Produce::opcode(PRINTNUMBER_BIP));
					Produce::down();
						Produce::val_symbol(K_value, gprk->n_s);
	...
	Produce::down();
		...
		Produce::up();
	Produce::up();
	Produce::inv_call_iname(Hierarchy::find(DETECTPLURALWORD_HL));
	Produce::down();
		Produce::val_symbol(K_value, gprk->original_wn_s);
		Produce::val_symbol(K_value, gprk->n_s);
	Produce::up();
...
void PL::Parsing::Tokens::General::consider_visible_property(gpr_kit *gprk, inference_subject *subj,
	...
	if (conditional_vis) { Produce::up(); Produce::up(); }
}
...
void PL::Parsing::Tokens::General::begin_distinguishing_visible_properties(gpr_kit *gprk) {
	...
	Produce::down();
		...
		Produce::down();
				...
				Produce::down();
					...
					Produce::down();
						...
						Produce::down();
							Produce::inv_primitive(Produce::opcode(PRINT_BIP));
							Produce::down();
								Produce::val_text(I"p1, p2 = ");
							Produce::up();
							Produce::inv_primitive(Produce::opcode(PRINTNUMBER_BIP));
							Produce::down();
								Produce::val_iname(K_value, Hierarchy::find(PARSER_ONE_HL));
							Produce::up();
							Produce::inv_primitive(Produce::opcode(PRINT_BIP));
							Produce::down();
								Produce::val_text(I", ");
							...
							Produce::inv_primitive(Produce::opcode(PRINTNUMBER_BIP));
							Produce::down();
								Produce::val_iname(K_value, Hierarchy::find(PARSER_TWO_HL));
							Produce::up();
							Produce::inv_primitive(Produce::opcode(PRINT_BIP));
							Produce::down();
								Produce::val_text(I"\n");
			...
			Produce::inv_primitive(Produce::opcode(STORE_BIP));
			Produce::down();
				Produce::ref_symbol(K_value, gprk->ss_s);
				Produce::val_iname(K_value, Hierarchy::find(SELF_HL));
			Produce::up();
}
...
void PL::Parsing::Tokens::General::test_distinguish_visible_property(gpr_kit *gprk, parse_node *spec) {
	...
	Produce::inv_primitive(Produce::opcode(STORE_BIP));
	Produce::down();
		Produce::ref_symbol(K_value, gprk->g_s);
		Specifications::Compiler::emit_as_val(K_truth_state, spec);
	Produce::up();
	...
	Produce::down();
		...
		Produce::down();
			Produce::val_symbol(K_value, gprk->f_s);
			Produce::val_symbol(K_value, gprk->g_s);
		Produce::up();
		Produce::code();
		Produce::down();
			@<Return minus two@>;
...
void PL::Parsing::Tokens::General::distinguish_visible_property(gpr_kit *gprk, property *prn) {
	...
	if (Properties::is_either_or(prn)) {
		...
		Produce::down();
			if (distinguisher) {
				Produce::inv_call_iname(distinguisher);
				Produce::down();
...
@<Return minus two@> =
	Produce::inv_primitive(Produce::opcode(RETURN_BIP));
	Produce::down();
		Produce::val(K_number, LITERAL_IVAL, (inter_t) -2);
	Produce::up();
...
void PL::Parsing::Tokens::General::finish_distinguishing_visible_properties(gpr_kit *gprk) {
			...
			Produce::down();
				Produce::ref_iname(K_value, Hierarchy::find(SELF_HL));
				Produce::val_symbol(K_value, gprk->ss_s);
			Produce::up();
			Produce::inv_primitive(Produce::opcode(RETURN_BIP));
			Produce::down();
				Produce::val(K_number, LITERAL_IVAL, 0);
...
void PL::Parsing::Tokens::General::parse_visible_property(gpr_kit *gprk,
	...
	if (Properties::is_either_or(prn)) {
		...
		inter_symbol *pass_label = Produce::reserve_label(L);
		DISCARD_TEXT(L);
		...
		Produce::place_label(pass_label);
	} else {
		Produce::inv_primitive(Produce::opcode(STORE_BIP));
		Produce::down();
			Produce::ref_iname(K_value, Hierarchy::find(WN_HL));
		...
		Produce::inv_primitive(Produce::opcode(STORE_BIP));
		Produce::down();
			Produce::ref_symbol(K_value, gprk->spn_s);
			Produce::val_iname(K_value, Hierarchy::find(PARSED_NUMBER_HL));
		Produce::up();
		Produce::inv_primitive(Produce::opcode(STORE_BIP));
		Produce::down();
			Produce::ref_symbol(K_value, gprk->ss_s);
			Produce::val_iname(K_value, Hierarchy::find(ETYPE_HL));
		Produce::up();
		...
		Produce::down();
			...
			if (recog_gpr) {
				Produce::inv_primitive(Produce::opcode(EQ_BIP));
				Produce::down();
					Produce::inv_call_iname(recog_gpr);
					Produce::down();
						Produce::inv_primitive(Produce::opcode(PROPERTYVALUE_BIP));
						Produce::down();
							Produce::val_iname(K_value, Hierarchy::find(SELF_HL));
				...
				if (i6_gpr_name) {
					...
					Produce::down();
						Produce::inv_primitive(Produce::opcode(EQ_BIP));
						Produce::down();
							Produce::inv_call_iname(i6_gpr_name);
					...
					Produce::inv_primitive(Produce::opcode(EQ_BIP));
					Produce::down();
						Produce::inv_call_iname(Kinds::RunTime::get_instance_GPR_iname(K));
						Produce::down();
							Produce::inv_primitive(Produce::opcode(PROPERTYVALUE_BIP));
							Produce::down();
								Produce::val_iname(K_value, Hierarchy::find(SELF_HL));
					...
					Produce::down();
						Produce::inv_primitive(Produce::opcode(EQ_BIP));
						Produce::down();
							Produce::inv_call_iname(Kinds::RunTime::get_kind_GPR_iname(K));
							Produce::val_iname(K_value, Hierarchy::find(GPR_NUMBER_HL));
						Produce::up();
						Produce::inv_primitive(Produce::opcode(EQ_BIP));
						Produce::down();
		...
		Produce::down();
			...
			Produce::val_symbol(K_value, gprk->spn_s);
		Produce::up();
		Produce::inv_primitive(Produce::opcode(STORE_BIP));
		Produce::down();
			Produce::ref_iname(K_value, Hierarchy::find(ETYPE_HL));
			Produce::val_symbol(K_value, gprk->ss_s);
		Produce::up();
	}
}
...
void PL::Parsing::Tokens::General::parse_visible_either_or(gpr_kit *gprk, property *prn, int visibility_level,
	...
	Produce::down();
		...
		int ands = 0;
		if (j > 0) { Produce::inv_primitive(Produce::opcode(AND_BIP)); Produce::down(); ands++; }
		Properties::Emit::emit_iname_has_property(K_value, Hierarchy::find(SELF_HL), prn);
		int k = 0;
		LOOP_THROUGH_WORDING(i, W) {
			if (k < j-1) { Produce::inv_primitive(Produce::opcode(AND_BIP)); Produce::down(); ands++; }
			Produce::inv_primitive(Produce::opcode(EQ_BIP));
			Produce::down();
				Produce::inv_call_iname(Hierarchy::find(NEXTWORDSTOPPED_HL));
				TEMPORARY_TEXT(N);
		...
		for (int a=0; a<ands; a++) Produce::up();
		Produce::code();
		Produce::down();
	...
	if (gv) {
		...
		Produce::down();
			...
			Produce::down();
				...
				Produce::inv_primitive(Produce::opcode(EQ_BIP));
				Produce::down();
					Produce::inv_call_iname(gv->gv_prn_iname);
					Produce::val_iname(K_value, Hierarchy::find(GPR_PREPOSITION_HL));
				Produce::up();
			Produce::up();
			Produce::code();
