...
by a |RULE_NT| node, and they organise what is to be compiled.
...
@d PARENTAGE_PERMISSIONS_SYNTAX_CALLBACK CoreSyntax::write_parentage_permissions
...
@d ANNOTATION_PERMISSIONS_SYNTAX_CALLBACK CoreSyntax::write_permissions
