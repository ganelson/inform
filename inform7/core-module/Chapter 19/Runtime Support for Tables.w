...
void Tables::Support::compile_print_table_names(void) {
	...
	Produce::down();
		...
		Produce::down();
			...
			Produce::down();
				Produce::val_iname(K_table, Hierarchy::find(THEEMPTYTABLE_HL));
				Produce::code();
				Produce::down();
					Produce::inv_primitive(Produce::opcode(PRINT_BIP));
					Produce::down();
						Produce::val_text(I"(the empty table)");
					Produce::up();
					Produce::rtrue();
				Produce::up();
			Produce::up();
		...
		if (t->amendment_of == FALSE) {
			Produce::inv_primitive(Produce::opcode(CASE_BIP));
			Produce::down();
				Produce::val_iname(K_table, Tables::identifier(t));
				Produce::code();
				Produce::down();
					Produce::inv_primitive(Produce::opcode(PRINT_BIP));
					Produce::down();
			...
			Produce::down();
				...
				Produce::down();
					Produce::inv_primitive(Produce::opcode(PRINT_BIP));
					Produce::down();
						Produce::val_text(I"** No such table **");
					Produce::up();
					Produce::rtrue();
				Produce::up();
			Produce::up();
