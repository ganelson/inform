...
text_stream *Instances::identifier(instance *I) {
	...
	return NounIdentifiers::identifier(I->tag);
}
...
inter_name *Instances::iname(instance *I) {
	...
	if (I->instance_iname == NULL) {
		...
		NounIdentifiers::noun_compose_identifier(I->instance_package, I->tag, I->allocation_id);
		I->instance_iname = NounIdentifiers::iname(I->tag);
