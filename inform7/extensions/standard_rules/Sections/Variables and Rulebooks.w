...
A first turn sequence rule (this is the initial scene changing rule): follow the scene changing rules. [4th.]
...
=
A last turn sequence rule (this is the final scene changing rule): follow the scene changing rules. [3rd from last.]
...
The last specific action-processing rule (this is the ultimate specific action-processing rule): rule succeeds.
