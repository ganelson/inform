...
![text](Figures/timings-diagnostics.txt)
...
![text](Figures/memory-diagnostics.txt)
...
![text](Figures/preform-summary.txt)
...
![text](Figures/syntax-summary.txt)

The unabridged tree is here:

![download: Complete syntax tree](syntax-diagnostics.txt)
